...
const Products = () => {
  ...
  // added to cart this product....................
    ...
    // spachial product.................................
    let hendeleParItems = (item) => {
      
    }
    let filterItem = produc.filter((item) => item.id >= 11 && item.id <= 20)
      ...
      <section className='container mx-auto py-10'>
        ...
        <div className="text-center mt-10          ">
            ...
            <div className=" flex justify-center md:gap-5 gap-2 mt-2 text-[12px] md:text-[15px]  ">
                <p onClick={()=> hendeleParItems(item) } className='hover:text-primary hover:underline'>New Arrival</p>
